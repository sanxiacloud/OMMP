...
Namespace dal.dao
    ...
    Public Class MiddlewareInstanceDAO
        ...
        Public Function Insert(ByVal o As Object) As Integer Implements IEntityDAO.Insert
            ...
            Return InsertObject(Of MiddlewareInstance)(CType(o, MiddlewareInstance))
        End Function

        Public Function Update(ByVal o As Object) As Boolean Implements IEntityDAO.Update
            Return UpdateFunctionalCI(o) And UpdateObject(Of MiddlewareInstance)(CType(o, MiddlewareInstance))
        End Function

        Public Function Delete(ByVal id As Integer) As Boolean Implements IEntityDAO.Delete
            Return DeleteFunctionalCI(id) And DeleteObject(Of MiddlewareInstance)(id)
        End Function
    End Class
