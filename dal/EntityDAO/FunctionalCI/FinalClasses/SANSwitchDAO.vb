...
Namespace dal.dao
    ...
    Public Class SANSwitchDAO
        ...
        Public Function Insert(ByVal o As Object) As Integer Implements IEntityDAO.Insert
            ...
            Return InsertObject(Of SANSwitch)(CType(o, SANSwitch))
        End Function

        Public Function Update(ByVal o As Object) As Boolean Implements IEntityDAO.Update
            Return UpdateDataCenterDevice(o) And UpdateObject(Of SANSwitch)(CType(o, SANSwitch))
        End Function

        Public Function Delete(ByVal id As Integer) As Boolean Implements IEntityDAO.Delete
            Return DeleteDataCenterDevice(id) And DeleteObject(Of SANSwitch)(id)
        End Function
