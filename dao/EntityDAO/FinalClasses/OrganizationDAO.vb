    ...
    Public Class OrganizationDAO
        ...
        Protected Overrides Function SetProperties(ByVal dr As DataRow) As Object
            ...
            With item
                ...
                ._IsDeleted = dr(Organization.C__ISDELETED)
        ...
        Public Function Insert(ByVal o As Object) As Boolean Implements IEntityDAO.Insert
            ...
            Try
                ...
                dr(Organization.C__CODE) = obj._code
        ...
        Public Function Update(ByVal o As Object) As Boolean Implements IEntityDAO.Update
            ...
            Try
                Dim dr As DataRow = DataTables(TABLE_NAME).Find(C__IDENTIFY & " = " & obj._Identify)
                If dr IsNot Nothing Then
                    ...
                    If obj.code IsNot Nothing Then
                        dr(Organization.C_CODE) = obj.code
                    End If
                    If obj._code IsNot Nothing Then
                        dr(Organization.C__CODE) = obj._code
                    End If
                    ...
                    If obj._IsDeleted = False Or obj._IsDeleted = True Then
                        dr(Organization.C__ISDELETED) = obj._IsDeleted
                    End If
                    If obj._sort >= 0 Then
                        dr(Organization.C__SORT) = obj._sort
                    End If
        ...
        '查询组织列表
        'Dim dao As New ommp.dao.OrganizationDAO
        'Dim lists As IList(Of ommp.dto.Organization) = dao.FindList2(Of ommp.dto.Organization)("[name] Like '%三峡云%'", "name desc")
        'output.Show("Count : " & lists.Count )
        'For Each dto As ommp.dto.Organization In lists 
        '    Output.Show("code_org_type = " & dto.code_org_type)
        '    Output.Show("Identify = " & dto._Identify)
        ...
        '查找一个组织
        'Dim dao As ommp.dao.OrganizationDAO = New ommp.dao.OrganizationDAO()
        'Dim dto As ommp.dto.Organization = dao.FindObject2(Of ommp.dto.Organization)(595)
        'Output.Show("code_org_type = " & dto.code_org_type)
        'Output.Show("Identify = " & dto._Identify)
        'Output.Show("parent_identify = " & dto.parent_identify)
        'Output.Show("name = " & dto.name)
